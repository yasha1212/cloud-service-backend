        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedCapacity = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FolderInfos_FolderInfos_FolderId",
                        column: x => x.FolderId,
                        principalTable: "FolderInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FolderInfos_Storages_StorageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExtensionId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    StorageId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    FolderId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileInfos_Extensions_ExtensionId",
                        column: x => x.ExtensionId,
                        principalTable: "Extensions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FileInfos_FolderInfos_FolderId",
                        column: x => x.FolderId,
                        principalTable: "FolderInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FileInfos_Storages_StorageId",
                        column: x => x.StorageId,
                        principalTable: "Storages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharingRules", x => new { x.FileId, x.UserId });
                    table.ForeignKey(
                        name: "FK_SharingRules_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SharingRules_FileInfos_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileInfos_FolderId",
                table: "FileInfos",
                column: "FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_FileInfos_StorageId",
                table: "FileInfos",
                column: "StorageId");

            migrationBuilder.CreateIndex(
                name: "IX_FolderInfos_FolderId",
                table: "FolderInfos",
                column: "FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_FolderInfos_StorageId",
                table: "FolderInfos",
                column: "StorageId");

            migrationBuilder.CreateIndex(
                name: "IX_SharingRules_UserId",
                table: "SharingRules",
                column: "UserId");
